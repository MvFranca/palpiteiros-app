...
import ProximasPartidas from "../../componentes/home/jogos/proximasPartidas/ProximasPartidas";
    ...
    return ( 
        ...
        <GeneralInfos>
            ...
            <LeftGeneral>
                ...
                <View>
                    <TextWhite style={{fontWeight: "bold", fontSize: 18}}>
                        Pauπteiros
                    </TextWhite>
                    <TextWhite style={{fontSize: 10}}>
                       01/02/2024 
                    </TextWhite>
                </View>
